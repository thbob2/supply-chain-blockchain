...
mongoose.connect('mongodb://mongodb:27017/carSupplyChain', { useNewUrlParser: true, useUnifiedTopology: true });
...
app.post('/register', async (req, res) => {
  ...
  await carSupplyChainContract.methods.registerCar(model).send({ from: accounts[0] });
